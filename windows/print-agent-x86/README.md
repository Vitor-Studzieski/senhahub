...
Em atualizações, ele remove o serviço, o executável e a configuração antigos e limpa os instaladores temporários que ele próprio extraiu. A pasta de estado é preservada para manter o pareamento e impedir reimpressões duplicadas.
